...
export function registerIpcHandlers() {
  ...
  ipcMain.handle('media:prepare-take-video', mediaHandlers.handlePrepareTakeVideo)
  ipcMain.on('media:cancel-prepare-take-video', mediaHandlers.handleCancelPrepareTakeVideo)
