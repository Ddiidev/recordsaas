...
export function AboutTab() {
  ...
  return (
    <div className="p-8 text-center flex flex-col items-center justify-center h-full">
      <img
        src="media://recordsaas-appicon.png"
        alt="RecordSaaS Logo"
      ...
      <div className="text-sm text-foreground space-y-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">Original creation with ❤️ by Tam Nguyen.</p>
        </div>
      ...
      <p className="absolute bottom-4 text-xs text-muted-foreground opacity-60">
