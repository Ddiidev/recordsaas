...
export const BLUR_REGION = {
  DEFAULT_DURATION: 3.0,
  STYLE: {
    DEFAULT: 'blur' as const,
    OPTIONS: ['blur', 'pixelated'] as const,
  },
  INTENSITY: {
    min: 1,
    max: 40,
  ...
  CAMERA: {
    STYLE: {
      ...
      BORDER: {
        ...
        WIDTH: { min: 1, max: 20, step: 1, defaultValue: 5 },
        DEFAULT_COLOR_RGBA: 'rgba(67, 56, 202, 0.7)', // Primary color
      },
    },
    PLACEMENT: {
